...
store.dispatch({
  ...
  payload: { amount: 1200, purpose: "Buy a bike" },
});
console.log(store.getState());
...
//we have to avoid side effects and logic in reducer so thats why\
//we placed the date function inside action creator
